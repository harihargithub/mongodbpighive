...
// Insert a few documents into the store collection.
db.getCollection('store').insertMany([
  {
    item: 'abc',
    price: 10,
    quantity: 2,
...
console.log(
  `${salesOnApril4th.length} store sales occurred on April 4th, 2014.`,
);
...
// Print the aggregation result to the output window.
console.log(aggregationResult);

// Return the aggregation result to show in the Playground Result panel.
aggregationResult;
